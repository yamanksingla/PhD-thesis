...
\usepackage{xurl}
\usepackage{graphicx}
\usepackage{lscape}  % For rotating content
...
\pagestyle{fancy} % Use a default fancy style globally
\renewcommand{\headrulewidth}{0pt} % Remove the header line
\renewcommand{\footrulewidth}{0pt} % Remove the footer line
\fancyhf{} % Clear default header and footer
\fancyfoot[C]{\thepage} % Place page numbers on the right for other pages
...
\clearpage
\listoffigures
%\addtocontents{toc}{\protect\contentsline{chapter}{List of Figures}{282}}
%\addcontentsline{toc}{chapter}{List of Figures}{282}
\suppressfloats[t]
\fi
...
\begin{singlespace}
\bibliography{ref}
%\addtocontents{toc}{\protect\contentsline{chapter}{Bibliography}{297}}
%\addcontentsline{toc}{chapter}{Bibliography}{297}
\end{singlespace}
